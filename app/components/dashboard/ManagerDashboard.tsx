      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-lg">
          <div className="p-4 border-b border-slate-700">
            <h3 className='font-semibold text-white'>Team Members ({allTeamMembers.length})</h3>
          </div>
          <div className="p-4">
            {
        ...
        {/* My Team Members */}
         <div className="bg-slate-800 border border-slate-700 rounded-lg">
          <div className="p-4 border-b border-slate-700">
            <h3 className='font-semibold text-white'>My Team Members ({myTeamMembers.length})</h3>
          </div>
          <div className="p-4">
            {
